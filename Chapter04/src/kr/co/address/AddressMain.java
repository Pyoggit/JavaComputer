...
public class AddressMain {
	...
	public static void insertAddress(ArrayList<Address> list, int type) {
	...
	public static Address searchAddress(ArrayList<Address> list, String zipcode) {
	...
	public static boolean deleteAddress(ArrayList<Address> list, String zipcode) {
	...
	public static void updateData(ArrayList<Address> list, String phoneNumber) {
	...
	public static void printAddress(ArrayList<Address> addressList) {
		for (Address data : addressList) {
			System.out.println(data);
		}
	}

	public static void sortAddress(ArrayList<Address> list) {
	...
	public static void reverseSortAddress(ArrayList<Address> list) {
	    Collections.sort(list, (a1, a2) -> {
	        return a2.getZipcode().compareTo(a1.getZipcode()); //람다식
	    });
